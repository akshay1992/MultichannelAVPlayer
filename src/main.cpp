...
//========================================================================
int main( ){
    int init_windowWidth = 320;
    int init_windowHeight = 256;
    ...
    settings.setPosition(ofVec2f(wX*3,wY*0));
    shared_ptr<ofAppBaseWindow> GUI = ofCreateWindow(settings);
    ofSetVerticalSync(false);
    GUI->setWindowTitle("GUI");
    ...
    ofAddListener(GUI->events().draw, mainApp.get(), &ofApp::draw_GUI);
